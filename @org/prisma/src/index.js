...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/humbledragon/Documents/GitHub/cf-workspace-example/@org/prisma/src",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/humbledragon/Documents/GitHub/cf-workspace-example/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
  ...
  "inlineSchemaHash": "a14d0dbefb6cec0f956d32bd9719199e78578e2b43f77f5373ed5e23ff162e39",
  "copyEngine": true
}
...
path.join(process.cwd(), "@org/prisma/src/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "@org/prisma/src/schema.prisma")
